// B3SLEP package to perform spin spherical harmonic transforms
// Copyright (C) 2011  Jason McEwen
// See LICENSE.txt for license details

/*! \mainpage B3SLEP C documentation
 *
 * The B3SLEP code provides functionality to perform fast and exact spin
 ...
 * For installation instructions, see the general B3SLEP 
